...
function AuthContextProvider({children}) {
    ...
    useEffect(() => {
        ...
        // als die er niet is, kkunnen we gewoon verder
        // als die token er wel is, dan betekend dat dat de applicatie herstart
        // en dan willen de nog even onze gebruikersdata (username, etc..)  ophalen.
